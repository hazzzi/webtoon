	...
	<div class="bw_writing"> 
		<form action="./fanModifyAction.fo?fa_num=<%=fa_num%>%pageNum=<%=pageNum%>" method="post" enctype="multipart/form-data">
			...
			<div class="bw_subject">
				<input type="text" class="bw_sub_tex"  name="fa_subject" value="<%=fb.getFa_subject()%>">
				<select id="bd_sel" name="fa_category">
				...
				<select id="bd_sel2" name="fa_catefory2">
					<optgroup label="웹툰 선택"></optgroup>
				</select>

			<div id="bw_img">
				<i class="fa fa-file-image-o" id="bw_pho_icon" style="font-size: 48px; color: gray; margin-left: -30px;"> 
