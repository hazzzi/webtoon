    ...
    return function(t) {
        ...
        t.exports = function(t, n) {
            ...
            return function(n, c, d) {
                for (var v, g, y = o(n), m = i(y), _ = r(c, d, 3), x = u(m.length), b = 0, w = e ? p(n, x) : f ? p(n, 0) : undefined; x > b; b++)
        ...
        if (e(6)) {
            ...
            p(Vt, Ut), h(Vt, dt, Ut.values), p(Vt, {
                ...
                h(g, gt, !0), h(S, _t, a), h(S, xt, !0), h(S, yt, g), (f ? new g(1)[vt] == a : vt in S) || W(S, vt, {
                    ...
                    from: Ft,
                    of: It
                }), "BYTES_PER_ELEMENT" in S || h(S, "BYTES_PER_ELEMENT", n), u(u.P, a, Lt), R(a), u(u.P + u.F * St, a, {
                    set: Ct
                }), u(u.P + u.F * !F, a, Ut), u(u.P + u.F * (S.toString != ht), a, {
                    toString: ht
            ...
            n = t.exports = function(t, n, e, l, h) {
                ...
                if (o(y)) {
                    for (p = c(t.length); p > _; _++)
                        if ((g = n ? m(u(d = t[_])[0], d[1]) : m(t[_])) === a || g === s) return g
                } else
        ...
        t.exports = function(t, n, e, v, g, y, m) {
            ...
            if (j && (b = l(j.call(new t))) !== Object.prototype && (s(b, S, !0), r || c(b, h) || u(b, h, d)), E && M && "values" !== M.name && (O = !0, P = function() {
                    return M.call(this)
                }), r && !m || !p && !O && k[h] || u(k, h, P), f[n] = P, f[S] = d, g)
                if (_ = {
                        values: E ? P : w("values"),
                        keys: y ? P : w("keys"),
                        entries: T
        ...
        t.exports = {
            getConstructor: function(t, n, e, s) {
                ...
                return o(l.prototype, {
                    ...
                    forEach: function(t) {
                        c(this, l, "forEach");
                        for (var n, e = u(t, arguments.length > 1 ? arguments[1] : undefined, 3); n = n ? n.n : this._f;)
        ...
        t.exports = !f || e(3)(function() {
            ...
            for (var e = u(t), f = arguments.length, a = 1, s = i.f, l = o.f; f > a;)
                for (var h, p = c(arguments[a++]), d = s ? r(p).concat(s(p)) : r(p), v = d.length, g = 0; v > g;) l.call(p, h = d[g++]) && (e[h] = p[h]);
            return e
        } : f
    }, function(t, n, e) {
        var r = e(7),
        ...
        !window.addEventListener && function(t, n, e, r, i, o, u) {
            t.addEventListener = n.addEventListener = e.addEventListener = function(t, n) {
                ...
                for (var e, r = 0; e = u[r]; ++r)
                    if (e[0] == this && e[1] == t && e[2] == n) return this.detachEvent("on" + t, u.splice(r, 1)[0][3])
        ...
        var r, i, o, u = e(112),
            ...
            I = function(t) {
                g.call(c, function() {
                    var n;
                    b ? _.emit("rejectionHandled", t) : (n = c.onrejectionhandled) && n({
                        promise: t,
                        reason: t._v
                    })
                })
        ...
        S || (x = function(t) {
            ...
            Promise: x
        }), e(77)(x, "Promise"), e(182)("Promise"), o = e(44).Promise, s(s.S + s.F * !S, "Promise", {
            reject: function(t) {
                var n = k(this);
        ...
        i(i.S + i.F * !e(68)(function(t) {
            ...
            from: function(t) {
                ...
                if (g && (v = r(v, d > 2 ? arguments[2] : undefined, 2)), m == undefined || p == Array && c(m))
                    for (n = f(h.length), e = new p(n); n > y; y++) a(e, y, g ? v(h[y], y) : h[y]);
                else
                    for (l = m.call(h), e = new p; !(i = l.next()).done; y++) a(e, y, g ? u(l, v, [i.value, y], !0) : i.value);
                return e.length = y, e
            }
        })
    }, function(t, n, e) {
        ...
        S || (x = function(t) {
            ...
            Promise: x
        }), e(49)(x, "Promise"), e(40)("Promise"), o = e(27).Promise, s(s.S + s.F * !S, "Promise", {
            reject: function(t) {
                var n = k(this);
                return (0, n.reject)(t), n.promise
            }
        ...
        e(64)("split", 2, function(t, n, r) {
            ...
            if ("c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1)[c] || 2 != "ab".split(/(?:ab)*/)[c] || 4 != ".".split(/(.?)(.?)/)[c] || ".".split(/()()/)[c] > 1 || "".split(/.?/)[c]) {
                ...
                r = function(t, n) {
                    ...
                    for (f || (r = new RegExp("^" + y.source + "$(?!\\s)", d));
                        (a = y.exec(e)) && !((s = a.index + a[0][c]) > v && (p.push(e.slice(v, a.index)), !f && a[c] > 1 && a[0].replace(r, function() {
        ...
        var r = e(2),
            ...
            K = function(t, n, e) {
                return t === D && K(B, n, e), _(t), n = b(n, !0), _(e), i(U, n) ? (e.enumerable ? (i(t, N) && t[N][n] && (t[N][n] = !1), e = S(e, {
                    enumerable: w(0, !1)
                })) : (i(t, N) || T(t, N, w(1, {})), t[N][n] = !0), z(t, n, e)) : T(t, n, e)
            },
            J = function(t, n) {
                _(t);
        ...
        var r = e(0);
        r(r.G + r.W + r.F * !e(72).ABV, {
            DataView: e(102).DataView
        })
    }, function(t, n, e) {
                    ...
                    if (t) {
                        ...
                        if (!isNaN(t.length)) {
                            var e = -1,
                                r = function i() {
                                    for (; ++e < t.length;)
                                        if (m.call(t, e)) return i.value = t[e], i.done = !1, i;
